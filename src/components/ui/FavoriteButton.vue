...
<template>
  <div
    ...
    :class="{
      'pointer-events-none': productStore.productLoading,
    }"
  >
    <div v-show="isFavorite && !showLoading">
    ...
    <div
      v-show="showLoading"
      class="w-10 h-10 border-2 border-gray-300 border-b-violet-500 rounded-full animate-spin"
    ></div>
  </div>
  <!-- </div> -->
</template>
